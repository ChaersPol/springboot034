...
## 本项目获取地址：https://www.bishecode.com/product/32/
...
图5.2 商品分类管理页面【此页面提供给管理员的功能有：查看已发布的商品分类数据，修改商品分类，商品分类作废，即可删除】
![alt text](images/image-4.png)

图5.3 商品信息管理页面【此页面提供给管理员的功能有：根据商品信息进行条件查询，还可以对商品信息进行新增、修改、查询操作等等】
![alt text](images/image-5.png)

图5.4 轮播图管理页面【此页面提供给管理员的功能有：根据轮播图进行新增、修改、查询操作等等】
